...
export CLAUDE_MCP_CONFIG="/workspaces/hackathon_training/Context-Engineering-Intro/mcp-integration/.mcp.json"
export PERPLEXITY_API_KEY="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"
export MEMORY_BANK_PATH="/workspaces/hackathon_training/Context-Engineering-Intro/mcp-integration/config/credentials/memory_bank"
...
print_status "✅ Configuration fix complete!"
print_warning "Next steps:"
echo "1. Run: source set-mcp-env.sh (to set environment variables)"
echo "2. Restart Claude Code completely"
echo "3. Test with: /mcp list (if available)"
echo "4. Or test Perplexity MCP functionality directly"